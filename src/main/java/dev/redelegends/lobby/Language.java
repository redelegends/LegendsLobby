...
public class Language {
  ...
  public static final LegendsLogger LOGGER = ((LegendsLogger) Main.getInstance().getLogger())
      .getModule("LANGUAGE");
  private static final LegendsConfig CONFIG = Main.getInstance().getConfig("language");
  ...
  public static List<String> scoreboards$lobby = Arrays
      .asList("",
              "Grupo: §b%LegendsCore_role%",
              "Cash: §a$%LegendsCore_cash%",
              "",
              "Lobby: §7#1",
              "Online: §b%LegendsCore_online%",
              "",
              "§bredelegends.com",
              "");
  ...
  public static String lobby$tab$header = " \n§b§lLEGENDS\n  §7www.redelegends.com\n ";
  public static String lobby$tab$footer =
      " \n \n§aForúm: §fredelegends.com/forum\n§aTwitter: §f@redelegends\n§aDiscord: §fdiscord.gg/redelegends\n \n                                          §bAdquira VIP acessando: §floja.redelegends.com                                          \n ";
  ...
  public static void setupLanguage() {
    boolean save = false;
    LegendsWriter writer = Main.getInstance().getWriter(CONFIG.getFile(),
        "LegendsLobby - Criado por nevesbr6 e shauuu_\nVersão da configuração: " + Main.getInstance()
      ...
      if (field.getName().contains("$") && !Modifier.isFinal(field.getModifiers())) {
        ...
        try {
          ...
          if (CONFIG.contains(nativeName)) {
            ...
            writer.set(nativeName, new LegendsWriter.YamlEntry(new Object[]{"", CONFIG.get(nativeName)}));
          } else {
            ...
            save = true;
            writer.set(nativeName, new LegendsWriter.YamlEntry(new Object[]{"", value}));
          }
